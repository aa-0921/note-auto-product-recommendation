...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    // リポジトリ固有の設定
    const title = '🛍️🉐 買ってよかったおすすめ商品まとめ | アマゾン | Amazon | お買い物 | コスパ | フォロバ | フォロバ100';
    ...
    const intro = [
      ...
      'コメントいただけると大変励みになります🛍️✨ 今後取り上げてほしいジャンルや商品なども募集しております。ご意見やご感想など、どのような内容でもお気軽にお寄せください💡',
      '',
      '---',
      '',
    ].join('\n');
    ...
    const closing = [
      ...
      'コメントいただけると大変励みになります🛍️✨ 今後取り上げてほしいジャンルや商品なども募集しております。ご意見やご感想など、どのような内容でもお気軽にお寄せください💡',
      '',
      '※ Amazon のアソシエイトとして、「買ってよかった🉐お買い物ナビ🎉」は適格販売により収入を得ています。',
      '',
