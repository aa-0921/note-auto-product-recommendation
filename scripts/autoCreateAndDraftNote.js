...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const articleConditionsLines = [
      ...
      'タイトルは1行目に「# [実際のタイトル] | アマゾン | Amazon | お得 | お買い物 | コスパ | フォロバ | フォロバ100 」として記載してください。',
    ...
    const tagsInstruction =
      '記事内容から最も関連する日本語タグを3〜5個生成し、半角スペース区切りで出力してください。必ず「#アマゾン #Amazon #お買い物 #商品紹介 #おすすめ #レビュー #PR」を含めてください。本文や説明は禁止。';
