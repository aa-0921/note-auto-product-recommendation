...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const commentGreetingPhrases = [
      'コメントさせていただきます🛍️フォロー・スキもさせていただきました💡',
      'コメントさせていただきます✨フォローとスキもいたしました🛍️',
      'コメント失礼します💡フォロー・スキも🛍️',
      '拝見してコメントしました🛍️フォロー・スキもさせていただきました💡',
      'フォロー・スキさせていただきました💡コメントさせていただきます🛍️',
      'フォロー・スキもさせていただきました✨コメントさせていただきます🛍️',
      'フォローとスキもしました🛍️コメントさせていただきます💡',
    ];
    ...
    const commentSuffixClosingPhrases = [
      '私の記事の方にもコメント・フォロー・スキをいただけますと大変うれしいです・・🙇‍♂️',
      '私の記事の方にもコメント・フォロー・スキいただけると嬉しいです🛍️',
      '私の方の記事にもスキやフォロー・コメントいただけたら励みになります💡',
      '私の記事へもコメント・フォロー・スキいただけると大変ありがたいです✨',
      '私のブログの方にもコメント・フォロー・スキいただけますと幸いです・・🙇‍♂️',
      '私の記事の方にもフォロー・スキ・コメントいただけると大変嬉しいです🛍️',
