...
export const eventAmazonArticleTitles = [
  '🎉 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール開催中！「買ってよかった」愛用品をお得にチェック | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🛍️ 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール情報をお届けします（美容・日用品編） | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '💰 【12/8(月)まで】今だけの特別価格！いつものケア用品をお得にストックできるブラックフライデー（アフターセール） | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '✨ 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール情報まとめ（スキンケア・ボディケア特集） | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🎁 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールお得な情報をお届けします（ご褒美コスメ編） | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🔥 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールでお買い物！「リピ買い確定アイテム」をお得に迎えるチャンス | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '💸 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールセール情報（ストック＆ご褒美バランスよく） | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
  '🎊 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール開催！愛用品・気になるアイテムの要チェックまとめ | Amazon | セール | お買い得 | お買い物 | お得 | フォロバ100 | フォロバ',
];
