...
// タイトル候補配列（美容・コスメ・日用品寄りのトーンで、12/1(月)までを明記）
export const eventAmazonArticleTitles = [
  '🎉 【12/1(月)まで】アマゾンブラックフライデーセール開催中！「買ってよかった」愛用品をお得にチェック',
  '🛍️ 【12/1(月)まで】アマゾンブラックフライデーセール情報をお届けします（美容・日用品編）',
  '💰 【12/1(月)まで】今だけの特別価格！いつものケア用品をお得にストックできるブラックフライデー',
  '✨ 【12/1(月)まで】Amazonブラックフライデーセール情報まとめ（スキンケア・ボディケア特集）',
  '🎁 【12/1(月)まで】Amazonブラックフライデーセールお得な情報をお届けします（ご褒美コスメ編）',
  '🔥 【12/1(月)まで】Amazonブラックフライデーセールでお買い物！「リピ買い確定アイテム」をお得に迎えるチャンス',
  '💸 【12/1(月)まで】Amazonブラックフライデーセールセール情報（ストック＆ご褒美バランスよく）',
  '🎊 【12/1(月)まで】Amazonブラックフライデーセール開催！愛用品・気になるアイテムの要チェックまとめ',
];
...
export const eventAmazonArticleSections = [
  {
    title: '## 🌈 Amazonブラックフライデーが開く未来：暮らしに「ポジティブな変化」を起こす瞬間',
    text: `🚀 最高の「気分転換」と「お得」を一度に手に入れるチャンスです！

いよいよ、Amazonの「ブラックフライデー」が始まります。この期間は、単なる値下げに目を奪われるのではなく、「あなたの暮らしを、より快適で楽しいものに変えるチャンス」として活用していただきたいのです。
...
「心の満足度」をアップ！ 欲しいものを手に入れたときの高揚感は、私たちの心に活力をもたらします。このポジティブな感情は、モヤモヤとした気分を吹き飛ばし、年末の忙しさに立ち向かうためのエネルギー源になってくれます。`,
  },
  {
    ...
    text: `ブラックフライデーの買い物は、将来的な後悔や失敗を防ぐための、非常に合理的な行動です。
...
浮いた時間で何をする？ 買い物に使うはずだった時間を使って、家族との団らんを楽しんだり、趣味の時間に充てたりできます。ブラックフライデーは、**「時間を有効に使うための機会」**でもあるのです。`,
  },
  {
...
心と暮らしが喜ぶ買い物を、Amazonブラックフライデーで実現してください。`,
  },
];
